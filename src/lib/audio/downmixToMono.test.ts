...
import { downmixToMono } from './downmixToMono'
...
describe('downmixToMono', () => {
  ...
  it('faz a média amostra a amostra em estéreo', () => {
    ...
    expect(downmixToMono([left, right])).toEqual(new Float32Array([0.5, 0.5, -0.75]))
  })
  ...
  it('faz a média de mais de dois canais', () => {
    ...
    expect(downmixToMono([a, b, c])).toEqual(new Float32Array([0, 1]))
  })
})

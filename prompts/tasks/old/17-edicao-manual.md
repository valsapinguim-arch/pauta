...
- Justificação: a maioria dos erros percebidos não são notas erradas — são o andamento ou a tonalidade errados, que fazem _todas_ as notas parecerem erradas. Corrigir o BPM resolve dezenas de notas de uma vez; editar nota a nota o que um ajuste de BPM resolvia é trabalho desperdiçado. A ordem na interface deve refletir isso.
...
- Ligar à gravação da Tarefa 16 com _debounce_

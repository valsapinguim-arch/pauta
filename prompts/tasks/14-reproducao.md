...
* Em iOS, criar ou retomar o `AudioContext` dentro do *handler* do clique de play — fora disso fica suspenso e não sai som, sem erro nenhum. Mesmo problema já anotado na Tarefa 4.

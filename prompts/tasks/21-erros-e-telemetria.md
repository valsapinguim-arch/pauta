...
- O utilizador vê a mensagem do catálogo; a mensagem original, o *stack trace* e o contexto vão para o registo local.
...
* "Detalhes técnicos (mensagem original, *stack trace*) nunca aparecem na interface e são sempre guardados no registo local."
